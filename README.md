...
BenchmarkTools.Trial: 16 samples with 1 evaluation per sample.
 Range (min … max):  271.465 ms … 435.818 ms  ┊ GC (min … max): 0.00% … 0.00%
 Time  (median):     312.851 ms               ┊ GC (median):    0.00%
 Time  (mean ± σ):   329.161 ms ±  47.695 ms  ┊ GC (mean ± σ):  0.00% ± 0.00%
...
Day 6 Timings:
 Range (min … max):  2.890 ms … 68.213 ms  ┊ GC (min … max): 0.00% …  0.00%
 Time  (median):     3.834 ms              ┊ GC (median):    0.00%
 Time  (mean ± σ):   4.330 ms ±  3.175 ms  ┊ GC (mean ± σ):  6.08% ± 11.69%
